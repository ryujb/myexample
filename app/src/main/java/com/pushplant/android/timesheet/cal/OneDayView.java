...
import com.pushplant.android.timesheet.R;
...
public class OneDayView extends RelativeLayout {
    ...
    private LinearLayout oneday_topGroup;


    private TextView onday_moonTv;
    ...
    private void init(Context context)
    {
        ...
        onday_moonTv = (TextView) v.findViewById(R.id.onday_moonTv);


        oneday_topGroup =(LinearLayout) v.findViewById(R.id.oneday_topGroup);
    ...
    //    oneday_topGroup.setBackgroundColor(Color.parseColor("#7FFF00"));
        oneday_topGroup.setBackgroundColor(Color.parseColor("#7FFF00"));
    }



    public void setbackcolor2(){


        oneday_topGroup.setBackgroundColor(Color.parseColor("#FFFFFF"));
    }
    ...
    public void refresh() {
       ...
       // msgTv.setText((one.getMessage()==null)?"":one.getMessage());
        ...
        onday_moonTv.setText(one.getMessage());
