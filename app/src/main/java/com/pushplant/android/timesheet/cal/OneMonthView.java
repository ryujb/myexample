...
import com.pushplant.android.timesheet.HLog;
import com.pushplant.android.timesheet.MConfig;
import com.pushplant.android.timesheet.Main2Activity;
...
public class OneMonthView extends LinearLayout implements View.OnClickListener {
    ...
    public OneMonthView(Context context, AttributeSet attrs, int defStyle) {
        ...
        HLog.d(TAG, CLASS,"OneMonthView - " +  defStyle);
        ...
        if(isInEditMode()) {
            ...
            HLog.i(TAG, CLASS, "isInEditMode [ " + cal.get(Calendar.YEAR)  + "-" + cal.get(Calendar.MONTH) + "]");
    ...
    public void make(int year, int month)
    {
        ...
        HLog.d(TAG, CLASS, " [make] - year - [" + year + "]  - month [" + month + "] ");
       ...
       //     HLog.d(TAG, CLASS, " [make]-pre - seekDay - [" + seekDay + "] -dayOfWeek - [" + dayOfWeek + "]");
     ...
     //       HLog.d(TAG, CLASS, " [make]-aa1["+ year + "-" + month +"] -[ " +  testcal.get(Calendar.DATE) + "-" + testcal.get(Calendar.MONTH) + "-" + testcal.get(Calendar.YEAR) +  "]");





            if((one.get(Calendar.YEAR) == testcal.get(Calendar.YEAR))&(one.get(Calendar.MONTH) == testcal.get(Calendar.MONTH))&(one.get(Calendar.DATE) == testcal.get(Calendar.DATE))) {
                ov.setbackcolor();
                HLog.d(TAG, CLASS, " aaaaaaa111111");
            }else{
                ov.setbackcolor2();
        //        HLog.d(TAG, CLASS, " bbbbbbbbbbbbb111111");
            }
    ...
    public void onClick(View v) {
        ...
        ((Main2Activity)mcontext).setList( ov.get(Calendar.YEAR), ov.get(Calendar.MONTH), ov.get(Calendar.DATE));

        HLog.d(TAG, CLASS, "click " + ov.get(Calendar.MONTH) + "/" + doubleString(ov.get(Calendar.DAY_OF_MONTH)));
